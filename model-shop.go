...
type GetShopInfoResponse struct {
	...
	SIPAShops []GetShopInfoResponseShop `json:"sip_a_shops"`
}
...
type PerformanceResponse struct {
	...
	SpamListingViolation []PerformanceResponsePerformance `json:"spam_listing_violation"`
	// Overall review rating is the average of all order ratings submitted by your buyers.
	OverallReviewRating []PerformanceResponsePerformance `json:"overall_review_rating"`
	// Preparation time is the number of days it takes a seller to prepare and ship out an order.
	AveragePreparationTime []PerformanceResponsePerformance `json:"average_preparation_time"`
	...
	LateShipmentRate []PerformanceResponsePerformance `json:"late_shipment_rate"`
	...
	ReturnRefundRate []PerformanceResponsePerformance `json:"return_refund_rate"`
	// Chat response time is the average time it takes a seller to respond to a buyer's chat message.
	ResponseTime []PerformanceResponsePerformance `json:"response_time"`
	...
	ProhibitedListingViolation []PerformanceResponsePerformance `json:"prohibited_listing_violation"`
	...
	CancellationRate []PerformanceResponsePerformance `json:"cancellation_rate"`
	...
	CounterfeitListingViolation []PerformanceResponsePerformance `json:"counterfeit_listing_violation"`
	// Your shop rating.
	ShopRating []PerformanceResponsePerformance `json:"shop_rating"`
	...
	ResponseRate []PerformanceResponsePerformance `json:"response_rate"`
	...
	NonFullfillmentRate []PerformanceResponsePerformance `json:"non_fullfillment_rate"`
	// The identifier for an API request for error tracking.
	RequestID string `json:"request_id"`
}
